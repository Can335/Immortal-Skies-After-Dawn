...
function CameraClass.New(Character: Model): CameraCS<any>
	...
	self.Crucial_Settings = {
		...
		state = "NaN",
		NormalCameraOffset = Vector3.new(2, 1, 8),
		AimingCameraOffset = Vector3.new(1.5, 0.5, 5),
		CameraSway = true,
		NormalCameraSwayDamper = 0.5,
		NormalCameraSwaySpeed = 2,
		AimingCameraSwayDamper = 1,
		AimingCameraSwaySpeed = 100,
		Smoothing = 15,
	...
	self.NormalSpring = SpringUtil.new(
		self.Crucial_Settings.NormalCameraSwayDamper,
		self.Crucial_Settings.NormalCameraSwaySpeed,
		Vector2.new()
	)
	self.AimingSpring = SpringUtil.new(
		self.Crucial_Settings.AimingCameraSwayDamper,
		self.Crucial_Settings.AimingCameraSwaySpeed,
		Vector2.new()
	)
...
function CameraClass:Cutscene() end
...
function CameraClass:Update(deltaTime)
	...
	local MouseDelta = -UserInputService:GetMouseDelta() / self.Crucial_Settings.Smoothing
	self.TargetRotation =
		Vector2.new(math.clamp(self.TargetRotation.X + MouseDelta.Y, -75, 75), self.TargetRotation.Y + MouseDelta.X)
...
function CameraClass:Shake() end
